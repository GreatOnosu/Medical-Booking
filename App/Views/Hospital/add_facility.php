		...
		<div class="admin-body">
			<div class="body-info">
				<div class="admin-form">
					<form action="Hospital/addfacility" method="post" enctype="multipart/form-data">
						<?=$stat?>
						<dt class="form-control">
							<input type="text" id="facility" name="facility" placeholder="Facility" required />
						</dt>
						<dt class="form-control">
							<input type="number" id="rate" name="rate" placeholder="Rate" required />
						</dt>
						<dt class="form-control">
							<label>Upload a Facility Photo</label>
							<input type="file" id="image" name="image" required />
						</dt>
						<dt class="form-control">
							<input type="submit" value="Add" name="btn_facility" class="btn-login" />
						</dt>
					</form>
				</div>
			</div>
