...
<body>
	...
	<div id="head-flow">
		...
		<div class="admin-body">
			<div class="body-info">
				<a href="Hospital/addfacility"><div class="request-appoint"><input type="submit" name="btn_add" value="Add Facility"></div></a>
				<table>
					<tr>
						<th>SN</th>
				    	<th>Facility</th>
				  	...
				  	<tr>
				  		...
				  		<td><?=$record->rate?></td>
				  		<td>
				  			<form action="Hospital/facility" method="post">
				  				<input type="submit" name="del_fac" value="Delete" />
